        ...
        ?>
            ...
            <div class="container-fluid mt-1">
                <div class="header-section fade-in">
                    <h5><i class="fa-solid fa-users me-2"></i>Customer Information</h5>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <div class="card-container fade-in">
                            <div class="align-items-center justify-content-between mb-3">
                                <h6 class="section-title mb-0"><i class="fa-solid fa-list me-2"></i>Customer List</h6>
                            </div>
                            <hr style="height: 1px">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <form class="p-3 needs-validation card-container fade-in" novalidate method="post" id="customerinfo" autocomplete="off">
                            
                            <div class="align-items-center justify-content-between mb-4">
                                <div>
                                    <button class="btn btn-primary mx-2" id="editButton" name="editButton" type="button" disabled><i class="fa-solid fa-pen-to-square me-1"></i> Edit</button>
                                    <button class="btn btn-success mx-2" id="addNew" type="button" name="addNew"><i class="fa-solid fa-plus me-1"></i> New</button>
                                </div>
                                <h6 class="section-title mb-0"><i class="fa-solid fa-user-plus me-2"></i>Customer Information</h6>
                            </div>
                            <hr style="height: 1px">
                            ...
                            <hr style="height: 1px;">
                            <p class="fw-medium section-title"><i class="fa-solid fa-location-dot me-2"></i>Address</p>
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <hr style="height: 1px;">
                            <p class="fw-medium section-title"><i class="fa-solid fa-box me-2"></i>Product Information</p>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-12 mt-3">
                                    <div class="d-flex justify-content-end gap-2">
                                        <button id="updateButton" class="btn btn-primary" style="display: none;" type="button" disabled><i class="fa-solid fa-upload me-1"></i>Update</button>
                                        <button id="submitButton" class="btn btn-primary" type="button" disabled><i class="fa-solid fa-check-circle me-1"></i> Submit</button>
                                        <button class="btn btn-danger" type="button" id="cancel" hidden onclick="Cancel();"><i class="fa-regular fa-circle-xmark me-1"></i> Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
