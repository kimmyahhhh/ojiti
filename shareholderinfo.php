                    ...
                    <form class="p-3 needs-validation shadow mb-4" novalidate method="POST" id="shareholderInfo">
                        ...
                        <div class="row">
                            <div class="col-12 text-end mt-3">
                                <button id="updateButton" disabled class="btn btn-primary mx-2 float-end" style="display: none;" type="button" form="shareholderInfo">
                                    <i class="fa-solid fa-upload"></i>Update
                                </button>

                                <button id="submitButton" name="submitButton" disabled class="btn btn-primary mx-2 float-end" type="button" form="shareholderInfo">
                                    <i class="fa-solid fa-check-circle"></i> Submit
                                </button>

                                <button class="btn btn-danger float-end" type="button" id="cancel" hidden disabled onclick="Cancel();">
