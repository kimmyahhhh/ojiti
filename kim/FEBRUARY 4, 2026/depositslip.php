                ...
                <div class="row mt-4">
                        ...
                        <div class=" shadow p-3 rounded-3  " style="background-color: white;">
                            ...
                            <form id="DepositTodayForm">
                                <div class="form-group row mb-1">
                                    <label for="lastdsno" class="col-sm-3 col-form-label">Date</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="lastdsno" id="lastdsno" placeholder="Select Date" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row mb-1">
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="depositSlipNo" id="depositSlipNo" class="form-control">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-8">
                        <div class=" shadow mb-3 p-3 rounded-2 " style="background-color: white;">
                            ...
                            <p class="fs-5 mb-0" style="color: #090909;">Undeposited ORs (for this DS) </p>
                            <button class="btn btn-sm btn-secondary" onclick="ReloadDepositDetails()"><i class="fa-solid fa-rotate"></i> Reload</button>
                        </div>
                        <hr style="height:1px">
