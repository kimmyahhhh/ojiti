...
<html lang="en" dir="ltr">
    ...
    <body class="  ">
        ...
        ?>    
            ...
            <div class="container-fluid mt-1">
                <div class="shadow rounded-3 p-3" style="background-color: white;">
                    <p style="color: blue; font-weight: bold;" class="fs-5 my-2 "><i class="fa-solid fa-file-contract me-2"></i>Other Payment</p>
                </div>
                <div class="row">
        ...
        <script>
            // Payment Amount - only numbers and decimal point
            ...
            // GL Total Amount - only numbers and decimal point
            document.getElementById('GLTotalAmount').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // SL Amount - only numbers and decimal point
            document.getElementById('SLAmount').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // Payee Text - no special characters, only letters, numbers, spaces, and basic punctuation
            document.getElementById('payeeTxt').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // Particulars - no special characters, only letters, numbers, spaces, and basic punctuation
            document.getElementById('particulars').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // Check No - only numbers
            document.getElementById('checkNo').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // Bank Name - no special characters, only letters, numbers, spaces, and basic punctuation
            ...
            // Bank Branch - no special characters, only letters, numbers, spaces, and basic punctuation
            document.getElementById('bankBranch').addEventListener('input', function(e) {
                let value = e.target.value;
            ...
            // Payee TIN - only numbers
            document.getElementById('payeeTIN').addEventListener('input', function(e) {
                let value = e.target.value;
                
                // Remove all characters except numbers
                value = value.replace(/[^0-9]/g, '');
                
                // Limit to 12 digits (standard TIN length)
                if (value.length > 12) {
            ...
            // Payee Address - no special characters, only letters, numbers, spaces, and basic punctuation
            document.getElementById('payeeAddress').addEventListener('input', function(e) {
                let value = e.target.value;
