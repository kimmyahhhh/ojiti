...
<html lang="en" dir="ltr">
    ...
    <body class="  ">
        ...
        <style>
            ...
            .shadow.p-3 { padding: 20px !important; }
            .rounded-2, .rounded-3 { border-radius: 10px !important; }
            .table-responsive { padding: 20px !important; }
            #particulars .fw-medium.fs-5, #summary .fw-medium.fs-5 { margin-left: 6px; }
            ...
            <div class="container mt-4">
                <div class="customer-profile shadow p-3 rounded-2 mb-2" style="background-color: white;">
