...
<html lang="en" dir="ltr">
    ...
    <body class="  ">
        ...
        <style>
            ...
            /* Force uppercase for input fields */
            input[type="text"] {
                    ...
                    <div>
                        <div class="shadow p-3 rounded-2" style="background-color: white;overflow:auto;">
                            <div class="align-items-center justify-content-between mb-3">
                                <button id="ConfigurationBtn" class="btn btn-secondary  px-3 py-2 float-end mx-2" type="button"><i class="fa-solid fa-gear"></i> Configuration</button>
                            ...
                            <div class="row">
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control form-control-sm" type="text" id="shSearch" list="shNamesList" placeholder="Search by name or info">
                                        <datalist id="shNamesList"></datalist>
                                    </div>
                                </div>
                            </div>
                            <table id="shareholderTbl" class="table table-bordered text-center" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:25%;text-align:center">Full Name</th>
                                        <th style="width:15%;text-align:center">Shareholder Type</th>
                    ...
                    <div class="col-md-12 mb-2">
                        <form class="p-3 needs-validation shadow mb-4" novalidate method="POST" id="shareholderInfo">
                            <div class=" align-items-center justify-content-between mb-3">
                                ...
                                <button id="editButton" class="btn btn-primary  px-3 py-2 float-end mx-2" type="button"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control searchName" id="shareholderName" name="shareholderName" placeholder="Shareholder Name" required autocomplete="off" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="09*********" maxlength="11" inputmode="numeric" pattern="\\d*" disabled oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="example@gmail.com"  disabled>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="facebook_account" name="facebook_account" placeholder="https://www.facebook.com/juan"  disabled>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example" id="shareholder_type" name="shareholder_type" disabled>
                                        ...
                                        <option value="BOARD OF DIRECTORS" selected>BOARD OF DIRECTORS</option>
                                        <option value="ASKI EMPLOYEE" selected>ASKI EMPLOYEE</option>
                                        <option value="RESIGNED STAFF" selected>RESIGNED STAFF</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="noofshare" name="noofshare" placeholder="" required oninput="calculateAmount()" disabled>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="amount_share" name="amount_share" placeholder=""  disabled>
                                    <div class="invalid-feedback">
                                        Please provide your Amount of Shares.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="dateEncoded" class="form-label mt-2">Date Encoded:</label>
                                    <input type="text" class="form-control date" id="dateEncoded" name="dateEncoded" placeholder="mm/dd/yyyy" disabled>
                                </div>
                        ...
                        <div class="modal-body">
                            <form id="configurationForm" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-sm" name="signatory1Name" id="signatory1Name" placeholder="Enter Name">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" name="signatory1Desig" id="signatory1Desig" placeholder="Enter Designation">
                                    </div>
                                </div>
                                <div class="form-group row mt-1">
                                    <label class="form-label">Signatory 2:</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-sm" name="signatory2Name" id="signatory2Name" placeholder="Enter Name">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" name="signatory2Desig" id="signatory2Desig" placeholder="Enter Designation">
                                    </div>
                                </div>
                                <div class="form-group row mt-1">
                                    <label class="form-label">Signatory Sub 2:</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-sm" name="signatorySub2Name" id="signatorySub2Name" placeholder="Enter Name">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" name="signatorySub2Desig" id="signatorySub2Desig" placeholder="Enter Designation">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-sm" name="currentCertNo" id="currentCertNo">
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <script src="../../js/profiling/shareholderinfo.js?v=<?php echo time(); ?>"></script>
