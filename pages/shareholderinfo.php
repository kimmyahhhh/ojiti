                        ...
                        <form class="p-3 needs-validation shadow mb-4" novalidate method="POST" id="shareholderInfo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="09*********" maxlength="11"  disabled>
                                    <div class="invalid-feedback">
                                    ...
                                    <table class="table table-bordered text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:20%;">Shareholder Type</th>
                                                <th style="width:20%;">No. Of Shares</th>
                                                <th style="width:20%;">Type</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td id="sumShareholderID"></td>
                                                <td id="sumFullName"></td>
                                                <td id="sumShareholderType"></td>
                                                <td id="sumNoOfShares"></td>
                                                <td id="sumType"></td>
                                            </tr>
                                        </tbody>
                                    </table>
