        ...
        .container { max-width: 96%; margin: 0 auto; padding-left: 8px; padding-right: 8px; }
            ...
            <div class="container mt-5 mb-4">
                <div class="customer-profile p-3 shadow rounded-2" style="background-color: white;">
                    <p style="color: blue; font-weight: bold;" class="fs-5 my-2">Fund Configuration</p>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-end">
                                        <button class="btn btn-success me-2" type="button"><i class="fa-solid fa-floppy-disk"></i> Save</button>
