    ...
    <body class="  ">
        ...
        ?>
            ...
            <style>
                ...
                /* Capitalize all inputs and selects for better viewing */
                input[type="text"], 
                select, 
                textarea, 
                .form-control,
                ...
                /* Keep placeholders readable if needed, or capitalize them too */
                input::placeholder {
                    text-transform: none;
                }
            </style>
                    ...
                    <div class="col-md-12 mt-1">
                        <form id="myForm" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="row mb-3">
                                        <label for="toRep" class="col-sm-1 col-form-label">TO:</label>
                    ...
                    <div class="col-md-6">
                        <div class="p-3 shadow rounded-3" style="background-color:white">
                            <form id="transmittalform" method="POST">
                                ...
                                <div class="row mt-2 mb-3" id="isynBranchContainer">
                                    <div class="col-md-3">
                        ...
                        <div class="modal-body">
                            <div class="row align-items-end g-2">
                                <div class="col-12 col-md-8">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-6">
                                            <label for="transmittalDateFrom" class="bold-label">From</label>
                                            <input type="text" name="transmittalDateFrom" id="transmittalDateFrom" class="form-control Date" placeholder="mm/dd/yyyy">
                                        </div>
                                        <div class="col-6">
                                            <label for="transmittalDateTo" class="bold-label">To</label>
                                            <input type="text" name="transmittalDateTo" id="transmittalDateTo" class="form-control Date" placeholder="mm/dd/yyyy">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 d-flex align-items-end">
                                    <div class="d-grid gap-2 w-100">
                                        <button class="btn btn-primary form-btn w-100" id="transmittalSearchBtn" name="transmittalSearchBtn" onclick="TransmittalSearch();"><i class="fa-solid fa-magnifying-glass"></i> Search</button>
                                        <button class="btn btn-secondary form-btn w-100" id="transmittalClearBtn" name="transmittalClearBtn" onclick="TransmittalClear();"><i class="fa-regular fa-circle-xmark"></i> Clear</button>
                                    </div>
                                </div>
                            </div>
                            <hr style="height: 1px">
