...
class Process extends Database
{
    ...
    public function LoadDataInventory(){
        $datainv = $this->SelectQuery("SELECT * FROM tbl_inventoryin ORDER BY DateAdded DESC LIMIT 1000");
    ...
    public function SaveAll($data){
        try {
            ...
            foreach ($entries as $entry) {
                ...
                $imageName = $entry[16] ?? ''; // Note: This is just the filename string, not the file
