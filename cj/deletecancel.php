    ...
    <body class="  ">
        ...
        ?>
            ...
            <style>
                ...
                #transactionTbl_wrapper .dataTables_scrollBody {
                ...
                <div class="row mt-4 mb-5">
                    <div class="col-md-8">
                        <div class="shadow p-3 rounded-3" style="background-color: white;">
                            ...
                            <div id="transactionNotice" class="small text-danger mb-2"></div>
                            ...
                            <div id="transactionPager" class="d-flex align-items-center gap-2 mt-2">
                                <button type="button" id="pagePrev" class="btn btn-sm btn-outline-secondary">Prev</button>
                                <div class="d-flex align-items-center gap-1">
                                    <span class="small text-muted">Page</span>
                                    <input type="number" id="pageNumber" class="form-control form-control-sm" style="width: 90px;" min="1" value="1">
                                    <span class="small text-muted">of</span>
                                    <span id="pageCount" class="small text-muted">1</span>
                                </div>
