                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <button type="button" class="btn btn-info px-3 py-2 mx-1" id="printRecentBtn" name="printRecentBtn" onclick="PrintRecentOut();"><i class="fa-solid fa-print"></i> Print Recent</button>
                                            </div>
                                        </div>
                                    </div>
                                    <hr style="height: 1px">
